...
class Args(object):
    input_image_path = r'image\1_2.jpg'  # image/coral.jpg image/tiger.jpg
    train_epoch = 64
    mod_dim1 = 64  #
    mod_dim2 = 32
    gpu_id = 0
...
class MyNet(nn.Module):
    def __init__(self, inp_dim, mod_dim1, mod_dim2):
        ...
        self.seq = nn.Sequential(
            nn.Conv2d(inp_dim, mod_dim1, kernel_size=3, stride=1, padding=1),#size3
            ...
            nn.Conv2d(mod_dim2, mod_dim1, kernel_size=3, stride=1, padding=1),#size3
            nn.BatchNorm2d(mod_dim1),
            nn.ReLU(inplace=True),
...
def run():
    ...
    #seg_map = segmentation.slic(image, n_segments=4000, compactness=100, sigma=0.2)
    ...
    cv2.imwrite("seg_%s_%ds.jpg" % (args.input_image_path[-7:], time1), show)
