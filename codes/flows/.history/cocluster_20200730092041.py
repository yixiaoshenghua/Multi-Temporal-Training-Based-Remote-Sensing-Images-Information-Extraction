...
def runModel(datadf,x1,y1,x2,y2,x_test1,y_test1,x_test2,y_test2,c=1.0,size=5,epoch=20,labelsize=1,sampletimes=10):
    ...
    for i in range(sampletimes):
        ...
        model1=GradientBoostedDecisionTree(n_iter=50,learning_rate=0.1)
        model2=GradientBoostedDecisionTree(n_iter=50,learning_rate=0.1)
        ...
        model3=GradientBoostedDecisionTree(n_iter=50,learning_rate=0.1)
        model4=GradientBoostedDecisionTree(n_iter=50,learning_rate=0.1)
