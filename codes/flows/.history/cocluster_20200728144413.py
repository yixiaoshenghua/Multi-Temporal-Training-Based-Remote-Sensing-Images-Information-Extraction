...
for i in range(1,4):
    ...
    resdf.to_csv(r"E:\project\images\sentinal\process\output\res\GBDT_resdf_consistency_quantile75_label"+str(i)+"_unlabel5_epoch20_c_1_0.csv",index=None)

# %%
data=[]
for i in range(1,4):
    data.append(np.loadtxt(open(r"E:\project\images\sentinal\process\output\res\resdf_consistency_label"+str(i)+"_unlabel5_epoch20_c_1_0.csv",'r'),delimiter=',',skiprows=1,dtype=np.float32))
...
plt.tight_layout()
plt.savefig(r"E:\project\images\sentinal\process\output\label5unlabel5epoch20c1_0Coloss123.jpg")
plt.show()
