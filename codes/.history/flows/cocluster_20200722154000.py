...
data=[]
for i in range(1,6):
    data.append(np.loadtxt(open(r"E:\project\images\sentinal\process\output\res\resdf_label"+str(i)+"_unlabel5_epoch20_c_1_2.csv",'r'),delimiter=',',skiprows=1,dtype=np.float32))
...
plt.title("labeldata 5 unlabeldata 5 c 1.2 (veg)",fontsize=20)
plt.tight_layout()
plt.gca().xaxis.set_major_formatter(ticker.FormatStrFormatter('%d'))
plt.savefig(r"E:\project\images\sentinal\process\output\label5unlabel5Epoch20c_1_2veg.jpg")
plt.show()
...
epochs=np.arange(1,21,dtype=np.int)
plt.figure(figsize=(10,8))
plt.plot(epochs,res[0][:,17],color='black',marker='^',linestyle='-.')
plt.plot(epochs,res[1][:,17],color='black',marker='*',linestyle='-.')
plt.plot(epochs,res[2][:,17],color='black',marker='+',linestyle='-.')
...
plt.title("Prediction differences between classifiers(self)",fontsize=20)
plt.tight_layout()
plt.savefig(r"E:\project\images\sentinal\process\output\label5unlabel5epoch20c1_2sePDC12345.jpg")
plt.show()
