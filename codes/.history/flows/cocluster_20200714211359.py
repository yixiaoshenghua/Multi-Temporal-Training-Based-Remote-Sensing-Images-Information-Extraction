...
for i in range(10):
    ...
    model1,model2,coscore1,coscore2=run(datadf,x_train1,y_train1,x_train2,y_train2,model1,model2,x_test1,y_test1,x_test2,y_test2,size=5,epoch=20)
    ...
    model3,model4,sescore1,sescore2=run(datadf,x_train3,y_train3,x_train4,y_train4,model3,model4,x_test1,y_test1,x_test2,y_test2,size=5,epoch=20,selflearn=True)
