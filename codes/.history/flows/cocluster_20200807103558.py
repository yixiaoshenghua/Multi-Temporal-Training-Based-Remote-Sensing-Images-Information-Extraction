...
i=0
plt.plot(epochs,res[i][:,0],color='black',marker='^',linestyle='-')
...
plt.title("labeldata "+str(2*i+1)+" unlabeldata 5 c 1.0 trees",fontsize=20)
plt.tight_layout()
plt.gca().xaxis.set_major_formatter(ticker.FormatStrFormatter('%d'))
plt.savefig(r"E:\project\images\sentinal\process\output\multi_label"+str(2*i+1)+"unlabel5Epoch20c_1_0_trees.jpg")
plt.show()
