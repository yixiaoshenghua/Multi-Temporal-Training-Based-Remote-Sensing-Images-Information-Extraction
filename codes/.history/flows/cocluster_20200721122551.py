...
#%%
for i in range(1,6):
    resdf=runModel(datadf,x1,y1,x2,y2,x_test1,y_test1,x_test2,y_test2,c=1.0,size=10,epoch=20,labelsize=i,sampletimes=10)
    resdf.to_csv(r"E:\project\images\sentinal\process\output\res\resdf_label"+str(i)+"_unlabel10_epoch20.csv",index=None)

# %%
data=[]
for i in range(1,6):
    data.append(np.loadtxt(open(r"E:\project\images\sentinal\process\output\res\resdf_label"+str(i)+"_unlabel5_epoch20.csv",'r'),delimiter=',',skiprows=1,dtype=np.float32))
...
plt.plot(epochs,res[0][:,2],color='black',marker='^',linestyle='-')
plt.plot(epochs,res[0][:,6],color='black',marker='o',linestyle='-')
plt.plot(epochs,res[0][:,10],color='black',marker='^',linestyle='-.')
plt.plot(epochs,res[0][:,14],color='black',marker='o',linestyle='-.')
plt.ylim(0.7,1)
plt.xlim(0,20)
plt.xticks(epochs)
...
plt.title("labeldata 1 unlabeldata 5 (building)",fontsize=20)
plt.tight_layout()
plt.gca().xaxis.set_major_formatter(ticker.FormatStrFormatter('%d'))
plt.savefig(r"E:\project\images\sentinal\process\output\label1unlabel5Epoch20building.jpg")
plt.show()
...
plt.tight_layout()
plt.savefig(r"E:\project\images\sentinal\process\output\sePDC12345.jpg")
plt.show()
