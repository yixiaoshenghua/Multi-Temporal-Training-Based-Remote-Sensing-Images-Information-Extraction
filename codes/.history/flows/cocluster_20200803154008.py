    ...
    if selflearn==False:
        for i in range(epoch):
            ...
            res2=classification_report(y_test2,y_pre2,
                                    target_names=['trees','shadows','water','roads','houses','fallow'],
                                    output_dict=True)
            resdf.iat[ii,0],resdf.iat[ii,1],resdf.iat[ii,2],resdf.iat[ii,3],resdf.iat[ii,4],resdf.iat[ii,5]=res1['trees']['f1-score'],res1['shadows']['f1-score'],res1['water']['f1-score'],res1['roads']['f1-score'],res1['houses']['f1-score'],res1['fallow']['f1-score'],res1['weighted']['f1-score']
            resdf.iat[ii,6],resdf.iat[ii,7],resdf.iat[ii,8],resdf.iat[ii,9],resdf.iat[ii,10],resdf.iat[ii,11]=res2['trees']['f1-score'],res2['shadows']['f1-score'],res2['water']['f1-score'],res2['roads']['f1-score'],res2['houses']['f1-score'],res2['fallow']['f1-score'],res2['weighted']['f1-score']
            if i%5==0:
                print("score: f1:%.5f f2:%.5f"%(res1['weighted']['f1-score'],res2['weighted']['f1-score']))
        ...
        for i in range(epoch):
            ...
            res2=classification_report(y_test2,y_pre2,
                                    target_names=['trees','shadows','water','roads','houses','fallow'],
                                    output_dict=True)
            resdf.iat[ii,12],resdf.iat[ii,13],resdf.iat[ii,14],resdf.iat[ii,15],resdf.iat[ii,16],resdf.iat[ii,17]=res1['trees']['f1-score'],res1['shadows']['f1-score'],res1['water']['f1-score'],res1['roads']['f1-score'],res1['houses']['f1-score'],res1['fallow']['f1-score'],res1['weighted']['f1-score']
            resdf.iat[ii,18],resdf.iat[ii,19],resdf.iat[ii,20],resdf.iat[ii,21],resdf.iat[ii,22],resdf.iat[ii,23]=res2['trees']['f1-score'],res2['shadows']['f1-score'],res2['water']['f1-score'],res2['roads']['f1-score'],res2['houses']['f1-score'],res2['fallow']['f1-score'],res2['weighted']['f1-score']
            if i%5==0:
...
def runModel(datadf,x1,y1,x2,y2,x_test1,y_test1,x_test2,y_test2,c=1.0,size=5,epoch=20,labelsize=1,sampletimes=10):
    resdf=pd.DataFrame(np.zeros((sampletimes*epoch,30)),
...
testloc1=lab1[:,:2]
testloc2=lab2[:,:2]
test1=addY(testloc1,data1total,[500]*6)
test2=addY(testloc2,data2total,[500]*6)
x_test1 = test1[:,:-1]
y_test1 = test1[:,-1]
x_test2 = test2[:,:-1]
y_test2 = test2[:,-1]
