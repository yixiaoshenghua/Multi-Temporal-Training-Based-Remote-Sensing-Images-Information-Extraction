...
for i in range(1,6,2):
    ...
    for j in range(20):
        ...
        for k in range(5):
            unlabeled_X_batch_train1,unlabeled_X_batch_train2=selectRand(unlabeled_X_train1,unlabeled_X_train2,i*40)
...
resdf.to_csv(r"E:\project\images\sentinal\process\output\res\resdf_consistency_GBDT_label135_unlabel_20times_sample40.csv",index=None)
# %%
