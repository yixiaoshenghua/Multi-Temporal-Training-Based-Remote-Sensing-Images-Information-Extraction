...
def run(resdf,datadf,x1,y1,x2,y2,model1,model2,x_test1,y_test1,x_test2,y_test2,c=1.0,size=50,epoch=20,selflearn=False,curepoch=0):
    if selflearn==False:
        for i in range(epoch):
            ...
            print(resdf.at[ii,'coLoss1'],resdf.at[ii,'coLoss2'])
...
for i in range(1,4):
    ...
    resdf.to_csv(r"E:\project\images\sentinal\process\output\res\resdf_consistency_label"+str(i)+"_unlabel5_epoch20_c_1_0.csv",index=None)
